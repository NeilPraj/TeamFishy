...
set(MP_CC "/opt/microchip/xc8/v4.00/bin/xc8-cc" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler")
set(MP_CC_DIR "/opt/microchip/xc8/v4.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "/opt/microchip/xc8/v4.00/bin/xc8-cc" CACHE FILEPATH "Path to the compiler binary")
...
set(MP_AS "/opt/microchip/xc8/v4.00/bin/xc8-cc" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler")
set(MP_AS_DIR "/opt/microchip/xc8/v4.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the assembler base directory")
set(CMAKE_ASM_COMPILER "/opt/microchip/xc8/v4.00/bin/xc8-cc" CACHE FILEPATH "Path to the compiler binary.")
set(MP_AS "${CMAKE_ASM_COMPILER}" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the assembler binary.")

set(MP_LD "/opt/microchip/xc8/v4.00/bin/xc8-cc" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")
set(MP_LD_DIR "/opt/microchip/xc8/v4.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the linker base directory")

set(MP_AR "/opt/microchip/xc8/v4.00/bin/xc8-ar" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")
set(MP_AR_DIR "/opt/microchip/xc8/v4.00/bin" CACHE PATH "Legacy variable from MPLAB X pointing to the archiver base directory")

set(CMAKE_AR "/opt/microchip/xc8/v4.00/bin/xc8-ar" CACHE FILEPATH "Path to the archiver binary.")

set(OBJDUMP "/opt/microchip/xc8/v4.00/bin/pic-objdump" CACHE FILEPATH "Path to objdump executable")
